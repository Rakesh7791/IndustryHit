 ...
 */
public class VolleyConnectionGET {
    ...
    private String mMethodName, requestType;
    private String[] mCurrentRequestParams;
    private boolean isRquestForPatym=false;

    public VolleyConnectionGET(Context context, OnVolleyResponseListener onVolleyResponseListener) {
        mContext = context;
        mOnVolleyResponseListener = onVolleyResponseListener;
    }

    public VolleyConnectionGET(Context context, OnVolleyResponseListener onVolleyResponseListener, boolean isRquestForPatym) {
        mContext = context;
        mOnVolleyResponseListener = onVolleyResponseListener;
        this.isRquestForPatym=isRquestForPatym;
    }

    public VolleyConnectionGET(Context context) {
        mContext = context;
    ...
    public boolean isRequestForPaytm(){
        return isRquestForPatym;
    }
...
//                                }
//                            }
//                            new VolleyConnectionGET(mContext, mOnVolleyResponseListener).execute(mCurrentRequestParams);
//                        } catch (Exception e) {
//                            e.printStackTrace();
//                        }
//                    }
